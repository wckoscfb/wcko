...
export const STRINGS = {
  ...
  'empty.browse_all':                { en: 'Or browse a team directly',  es: 'O explora un equipo directamente', fr: 'Ou parcourez une équipe directement', pt: 'Ou explore uma equipa diretamente' },
  'empty.about_heading':             { en: 'About WCKO',                 es: 'Sobre WCKO',              fr: 'À propos de WCKO',        pt: 'Sobre o WCKO' },
  'empty.about_body':                { en: 'WCKO is a free, interactive bracket simulator for the 2026 FIFA World Cup. Drag teams through every knockout round — Round of 32, Round of 16, Quarter-finals, Semi-finals, Final — and see exactly who your team would face on the road to the trophy. Match odds estimate automatically from live bookmaker data, or you can set them yourself. No signup, no ads.', es: 'WCKO es un simulador interactivo y gratuito del cuadro del Mundial 2026. Arrastra equipos por cada ronda eliminatoria — Dieciseisavos, Octavos, Cuartos, Semifinales, Final — y descubre exactamente a quién se enfrentaría tu equipo camino a la copa. Las cuotas se estiman automáticamente desde datos en directo de las casas de apuestas, o puedes ajustarlas tú. Sin registro, sin anuncios.', fr: 'WCKO est un simulateur de tableau interactif et gratuit pour la Coupe du Monde 2026. Faites glisser des équipes à travers chaque tour à élimination directe — Seizièmes, Huitièmes, Quarts, Demi-finales, Finale — et découvrez exactement qui votre équipe affronterait sur la route du trophée. Les cotes sont estimées automatiquement à partir des données en direct des bookmakers, ou vous pouvez les régler vous-même. Sans inscription, sans publicité.', pt: 'O WCKO é um simulador interativo e gratuito do quadro do Mundial 2026. Arraste equipas por cada ronda eliminatória — 16-avos, Oitavos, Quartos, Meias-finais, Final — e descubra exactamente contra quem a sua equipa jogaria a caminho do troféu. As odds estimam-se automaticamente a partir de dados em direto das casas de apostas, ou pode defini-las você mesmo. Sem registo, sem anúncios.' },
